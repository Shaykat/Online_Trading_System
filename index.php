<?php
	session_start();
	//logout hole eta change kore dhkis ow kaj kore kina' 
	session_destroy();
?>
	...
	<div id="div-top" style="height: 249px; width: 755px; border:black; margin-top: 20px; float: left;"> 
		<fieldset>
			...
			<div style="float: left; margin-left: 100px;">
				...
				<center> <a href="requestholder.php ? advertisement_showProductCategorywithoutlogin&category=product"> Electronics </a> </center>
			</div>

			<div style="float: left; margin-left: 5px;">
				<a> <img src="IMG/property.jpg" width="100"> </a>
				<center> <a href="requestholder.php ? advertisement_showProductCategorywithoutlogin&category=property"> Property </a> </center>
			</div>

			<div style="float: left; margin-left: 5px;">
				<a> <img src="IMG/job.jpg" width="100"> </a>
				<center> <a href="requestholder.php ? advertisement_showjobLiswithoutlogin"> Jobs </a> </center>
			</div>
